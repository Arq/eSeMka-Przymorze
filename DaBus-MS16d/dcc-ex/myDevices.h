...
//HAL(EXIOExpander,DS00,32,0x66)  // DABUS-MS-MASTER Occupancy Digital Sensor
//HAL(PCF8575,DS00, 16, 0x66) 
HAL(DABUS,DS00,64, 0x66) 
...
//****  SENSORS   ****//
JMRI_SENSOR(DS00,64)    //(vPIN,[count)]) - Creates <S> type sensor
